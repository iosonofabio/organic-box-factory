...
PACMAN_PACKAGES=('binutils' 'gcc' 'gzip' 'fakeroot' 'wget' 'make' 'git' 'boost' 'boost-libs' 'python' 'python2' 'python2-setuptools' 'python-numpy' 'cmake' 'python-pytest' 'doxygen' 'python-setuptools' 'python-sphinx' 'hdf5' 'python-h5py' 'graphviz')
